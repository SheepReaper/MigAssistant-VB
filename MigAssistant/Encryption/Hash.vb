...
#Region "  Hash"
    ...
    Public Class Hash
        ...
        Private ReadOnly _hash As HashAlgorithm
        Private ReadOnly _hashValue As New Data
        ...
        ''' </summary>
        Public Function Calculate(ByRef s As Stream) As Data
        ...
        ''' </summary>
        Public Function Calculate(d As Data) As Data
        ...
        ''' </summary>
        Public Function Calculate(d As Data, salt As Data) As Data
        ...
        ''' </summary>
        Private Function CalculatePrivate(b() As Byte) As Data
...
#Region "  CRC32 HashAlgorithm"
        ...
        Private Class Crc32
            ...
            Private _result As Integer = &HFFFFFFFF
            ...
            Protected Overrides Sub HashCore(array() As Byte, ibStart As Integer, cbSize As Integer)
                ...
                For i As Integer = ibStart To cbSize - 1
                    lookup = (_result And &HFF) Xor array(i)
                    _result = ((_result And &HFFFFFF00)\&H100) And &HFFFFFF
                    _result = _result Xor _crcLookup(lookup)
                Next i
            End Sub

            Protected Overrides Function HashFinal() As Byte()
                Dim b() As Byte = BitConverter.GetBytes(Not _result)
                Array.Reverse(b)
                Return b
            End Function
            ...
            Private ReadOnly _crcLookup() As Integer = { _
